...
BIS-recognised laboratories](../apex-accreditation/nabl.md); the mark itself
sits at the bottom "marks on the product" layer of the four-layer model
described in the [repo overview](../00-overview.md), directly under BIS as
...
[Compulsory Registration Scheme](bis-crs.md) for electronics/IT hardware,
[Hallmarking](bis-hallmarking.md) for precious metals, and BIS's own
commercial [Management System Certification](bis-management-system-certification.md).
